...
namespace NzbDrone.Core.Tv
{
    public interface ISeriesRepository : IBasicRepository<Series>
    {
        ...
        Task<Dictionary<int, int>> AllSeriesTvdbIdsAsync(CancellationToken cancellationToken = default);
    ...
    public class SeriesRepository : BasicRepository<Series>, ISeriesRepository
    {
        ...
        public async Task<Dictionary<int, int>> AllSeriesTvdbIdsAsync(CancellationToken cancellationToken = default)
        {
            await using var conn = await _database.OpenConnectionAsync(cancellationToken);

            return await conn.QueryUnbufferedAsync<KeyValuePair<int, int>>("SELECT \"Id\" AS Key, \"TvdbId\" AS Value FROM \"Series\"")
