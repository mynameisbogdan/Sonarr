...
namespace NzbDrone.Core.Tv
{
    public interface ISeriesService
    {
        ...
        Task<Dictionary<int, int>> AllSeriesTvdbIdsAsync(CancellationToken cancellation = default);
    ...
    public class SeriesService : ISeriesService
    {
        ...
        public async Task<Dictionary<int, int>> AllSeriesTvdbIdsAsync(CancellationToken cancellation = default)
        {
