...
namespace Sonarr.Api.V3.Wanted
{
    ...
    public class MissingController : EpisodeControllerWithSignalR
    {
        ...
        public PagingResource<EpisodeResource> GetMissingEpisodes([FromQuery] PagingRequestResource paging, bool includeSeries = false, bool includeImages = false, bool includeSpecials = false, bool monitored = true)
        {
